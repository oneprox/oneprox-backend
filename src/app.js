...
const depositoLogUc = require('./usecases/DepositoLog');
...
const complaintReportRepository = new ComplaintReportRepository(ComplaintReport, User, Tenant, modelComplaintReportEvidence, modelComplaintReportLog, Asset, modelRole);
...
const depositoLogUsecase = new depositoLogUc(depositoLogRepository, tenantRepository);
...
const tenantRouter = tenant.InitTenantRouter(tenantUsecase, tenantPaymentLogUsecase, tenantLegalUsecase, depositoLogUsecase);
...
const jsonBodyLimit = process.env.JSON_BODY_LIMIT || '30mb';
